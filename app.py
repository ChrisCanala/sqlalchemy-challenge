...
# Database Setup
#################################################
engine = create_engine("sqlite+pysqlite:///Starter_Code/Resources/hawaii.sqlite")
...
# The function `calc_temps` will accept start date and end date in the format '%Y-%m-%d' 
